...
pub struct CliArgs {
    ...
    #[clap(
        long,
        default_value = "2",
        help = "Keep distance to virtual chain tip, higher value avoids reorgs. Is multiplied by net bps."
    )]
    pub vcp_distance: u8,
    #[clap(long, default_value = "4", help = "Poll interval for vcp (in seconds)")]
    pub vcp_interval: u8,
